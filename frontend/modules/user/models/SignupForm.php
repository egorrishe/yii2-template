...
class SignupForm extends Model
{
     ...
     * Signs user up.
     *
     * @return null|User whether the creating new account was successful and email was sent
     */
     ...
     *
     * @param \common\models\user\User $user user model to with email should be send
     *
